...
import { PresenceContext, type PresenceContextProps } from '../../context/PresenceContext.js';
import type { ScrapeMotionValuesFromProps } from '../../render/types.js';
...
export const makeUseVisualState =
	...
	(props: MotionProps, _isStatic: boolean): VisualState<I, RS> => {
		const context = MotionContext[0]();
		const presenceContext = PresenceContext[0]();
